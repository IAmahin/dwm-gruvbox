...
static const char *fonts[]          = { "JetBrainsMono Nerd Font Propo:size=10:style=ExtraBold" };
...
static const char *note[]         = { "gedit", "/home/i/.config/Clipboard/note", NULL };
...
static const char *wal_picker[]   = { "wal_picker", NULL };


static const Key keys[] = {
	/* modifier                     key        function        argument */
        { MODKEY|ShiftMask,             XK_b,      spawn,          {.v = wal_picker } },
        { MODKEY|ShiftMask,             XK_p,      spawn,          {.v = power_menu } },
